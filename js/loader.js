(async function () {
    ...
    if (('undefined' != typeof EJS_DEBUG_XX && true === EJS_DEBUG_XX)) {
        ...
        await loadScript('js/nipplejs.js');
        await loadScript('js/shaders.js');
        await loadScript('js/storage.js');
        await loadScript('js/gamepad.js');
        await loadScript('js/GameManager.js');
        await loadScript('js/socket.io.min.js');
        await loadStyle('css/emulator.css');
    } else {
        await loadScript('js/emulator.min.js');
        await loadStyle('css/emulator.min.css');
    }
    const config = {};
    ...
    if (typeof window.EJS_language === "string" && window.EJS_language !== "en-US") {
        try {
            ...
            if ('undefined' != typeof EJS_paths && typeof EJS_paths[window.EJS_language] === 'string') {
                ...
                path = "/data/" + window.EJS_language + ".json";
            }
